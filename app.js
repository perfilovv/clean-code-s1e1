...
var incompleteTaskHolder=document.querySelector(".incomplete-tasks-list");//ul of #incomplete-tasks
...
var createNewTaskElement=function(taskString){
    ...
    deleteButtonImg.classList.add('delete-task-btn__img');
    ...
    editButton.className="edit-task-btn button";

    deleteButton.className="delete-task-btn button";
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.classList.add('completed-task-list__element');
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.classList.add('incomplete-task-list__element');
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
